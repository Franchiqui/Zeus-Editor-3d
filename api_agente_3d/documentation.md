# Api_Agente_3D API API Documentation
...
## Base URL
```
/api/v1/api_agente_3d api
```

## Endpoints

### GET /api_agente_3d api
Get all api_agente_3d api records
...
### GET /api_agente_3d api/{id}
Get a specific api_agente_3d api record by ID
...
### POST /api_agente_3d api
Create a new api_agente_3d api record
...
### PUT /api_agente_3d api/{id}
Update a api_agente_3d api record
...
### DELETE /api_agente_3d api/{id}
Delete a api_agente_3d api record
...
### Api_Agente_3D API Schema
```typescript
interface Api_Agente_3DAPI {
  id: string;
  name: string;
  description?: string;
  createdAt: Date;
...
```bash
npm install api_agente_3d api-sdk
```

## SDK Usage

```typescript
import { Api_Agente_3DAPIAPI } from 'api_agente_3d api-sdk';

const api = new Api_Agente_3DAPIAPI();
